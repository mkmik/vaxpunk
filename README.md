...
| `vtools/` | VMS-style toolchain in Rust: the `vasm` assembler, object and image formats, `vdump` to inspect them, and `vrun`, which runs images in QEMU; see [vtools/PRD.md](vtools/PRD.md) | `vtools/target/` |
